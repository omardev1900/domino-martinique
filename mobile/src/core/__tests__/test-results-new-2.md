...
FAIL src/core/StressTest.test.ts
  ● Console
    ...
    console.log
      TIE AT MANCHE THRESHOLD (Points: 0)! Continuing for another manche...

      at log (src/core/ScoringEngine.ts:169:29)
  ...
  ● Phase 2.3: Stress Test Simulation › Match termination in MANCHE mode
    ...
    [0m [90m 56 |[39m     test([32m'Match termination in MANCHE mode'[39m[33m,[39m () [33m=>[39m {
     [90m 57 |[39m         [36mconst[39m { state } [33m=[39m simulateMatch([32m'MANCHE'[39m[33m,[39m [35m3[39m)[33m;[39m
    [31m[1m>[22m[39m[90m 58 |[39m         expect(state[33m.[39mphase)[33m.[39mtoBe([32m'MATCH_END'[39m)[33m;[39m
     [90m    |[39m                             [31m[1m^[22m[39m
     [90m 59 |[39m         expect(state[33m.[39mplayers[33m.[39msome(p [33m=>[39m p[33m.[39mmancheWins [33m>=[39m [35m3[39m))[33m.[39mtoBe([36mtrue[39m)[33m;[39m
     [90m 60 |[39m     })[33m;[39m
     [90m 61 |[39m[0m

      at Object.toBe (src/core/StressTest.test.ts:58:29)

  ● Phase 2.3: Stress Test Simulation › Match termination in SCORE mode
    ...
    [0m [90m 62 |[39m     test([32m'Match termination in SCORE mode'[39m[33m,[39m () [33m=>[39m {
     [90m 63 |[39m         [36mconst[39m { state } [33m=[39m simulateMatch([32m'SCORE'[39m[33m,[39m [35m20[39m)[33m;[39m
    [31m[1m>[22m[39m[90m 64 |[39m         expect(state[33m.[39mphase)[33m.[39mtoBe([32m'MATCH_END'[39m)[33m;[39m
     [90m    |[39m                             [31m[1m^[22m[39m
     [90m 65 |[39m         expect(state[33m.[39mplayers[33m.[39msome(p [33m=>[39m p[33m.[39mtotalPoints [33m>=[39m [35m20[39m))[33m.[39mtoBe([36mtrue[39m)[33m;[39m
     [90m 66 |[39m     })[33m;[39m
     [90m 67 |[39m[0m

      at Object.toBe (src/core/StressTest.test.ts:64:29)
...
FAIL src/components/game/__tests__/GameHeader.test.tsx (5.391 s)
  ● Console
...
FAIL src/components/game/__tests__/GameOverlays.test.tsx (7.296 s)
  ● Console
...
FAIL src/hooks/game/__tests__/useGameSync.test.ts (13.342 s)
  ● Console
...
Tests:       21 failed, 98 passed, 119 total
Snapshots:   0 total
Time:        15.544 s
Ran all test suites.
