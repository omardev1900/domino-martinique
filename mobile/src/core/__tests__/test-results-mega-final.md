...
PASS src/__tests__/MultiplayerCochonSync.integration.test.ts
  ● Console
...
FAIL src/components/game/__tests__/GameHeader.test.tsx (7.019 s)
  ● Console
...
FAIL src/hooks/game/__tests__/useGameEngine.test.tsx (8.082 s)
  ● Console
    ...
    console.error
      [ActionDispatcher] Erreur durant l'action: Error: Player has valid moves, cannot pass
          ...
          at Object.dispatch [as handlePassTurn] (E:\HAPPYAGENCY\00 Clients\00 En cours\Manuel\code src\react-native\mobile\src\hooks\game\useGameEngine.ts:141:9)
    ...
    [31m[1m>[22m[39m[90m 173 |[39m             console[33m.[39merror([32m'[ActionDispatcher] Erreur durant l\'action:'[39m[33m,[39m e)[33m;[39m
     ...
     [90m 176 |[39m             releaseLock()[33m;[39m[0m
      ...
      at Object.dispatch [as handlePassTurn] (src/hooks/game/useGameEngine.ts:141:9)
  ...
  ● useGameEngine Hook (Component Wrapper) › handles playing a domino successfully
    ...
    [0m [90m 93 |[39m         expect(mockOnTilePlayed)[33m.[39mtoHaveBeenCalled()[33m;[39m
     [90m 94 |[39m         expect(mockSetGameState)[33m.[39mtoHaveBeenCalled()[33m;[39m
    [31m[1m>[22m[39m[90m 95 |[39m         expect([33mDominoEngine[39m[33m.[39mhandleTurn)[33m.[39mtoHaveBeenCalled()[33m;[39m
     [90m    |[39m                                         [31m[1m^[22m[39m
     [90m 96 |[39m         expect(mockClearAllTimers)[33m.[39mtoHaveBeenCalled()[33m;[39m
     [90m 97 |[39m     })[33m;[39m
     [90m 98 |[39m[0m

      at Object.toHaveBeenCalled (src/hooks/game/__tests__/useGameEngine.test.tsx:95:41)
      at asyncGeneratorStep (node_modules/@babel/runtime/helpers/asyncToGenerator.js:3:17)
      at _next (node_modules/@babel/runtime/helpers/asyncToGenerator.js:17:9)
...
PASS src/components/game/__tests__/PlayerArea.test.tsx (9.586 s)
...
FAIL src/components/game/__tests__/GameOverlays.test.tsx (11.182 s)
  ● Console
...
FAIL src/hooks/game/__tests__/useGameSync.test.ts (13.146 s)
  ● Console
...
PASS src/core/__tests__/GameStressTest.test.ts (20.968 s)
  ● Console
    ...
    console.log
      TIE AT MANCHE THRESHOLD (Points: 7)! Continuing for another manche...
