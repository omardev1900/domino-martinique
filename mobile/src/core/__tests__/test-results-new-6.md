...
FAIL src/__tests__/MultiplayerCochonSync.integration.test.ts
  ● Console
    ...
    console.log
      TIE AT COCHON THRESHOLD (1)! Continuing for another manche...

      at log (src/core/ScoringEngine.ts:193:29)
...
FAIL src/components/game/__tests__/GameHeader.test.tsx (5.198 s)
  ● Console
...
FAIL src/components/game/__tests__/GameOverlays.test.tsx (8.507 s)
  ● Console
...
FAIL src/hooks/game/__tests__/useGameSync.test.ts (12.624 s)
  ● Console
...
PASS src/core/__tests__/GameStressTest.test.ts (12.296 s)
  ● Console
