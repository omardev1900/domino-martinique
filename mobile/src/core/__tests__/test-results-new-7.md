...
FAIL src/core/__tests__/ScoringScenarios.test.ts
  ● Console
    ...
    console.error
      Player A: Stars=3, TotalPts=31, IsCochon=false
...
FAIL src/components/game/__tests__/GameHeader.test.tsx (5.965 s)
  ● Console
...
FAIL src/core/__tests__/GameIntegration.test.ts
  ...
  ● GameIntegration - Full Game Simulation › should simulate a full match between 3 bots without crashing
    ...
    [0m [90m  96 |[39m
     [90m  97 |[39m         [90m// Assertions[39m
    [31m[1m>[22m[39m[90m  98 |[39m         expect(state[33m.[39mphase)[33m.[39mtoBe([32m'MATCH_END'[39m)[33m;[39m
     [90m     |[39m                             [31m[1m^[22m[39m
     [90m  99 |[39m         expect(winner)[33m.[39mtoBeDefined()[33m;[39m
     [90m 100 |[39m         [90m// Check no pig (isCochon) logic if needed, but basic check passes.[39m
     [90m 101 |[39m     })[33m;[39m[0m

      at Object.toBe (src/core/__tests__/GameIntegration.test.ts:98:29)
...
PASS src/components/game/__tests__/PlayerArea.test.tsx (5.904 s)
FAIL src/components/game/__tests__/GameOverlays.test.tsx (8.784 s)
  ● Console
...
FAIL src/hooks/game/__tests__/useGameSync.test.ts (12.541 s)
  ● Console
...
PASS src/core/__tests__/GameStressTest.test.ts (14.133 s)
  ● Console
