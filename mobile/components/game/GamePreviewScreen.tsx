...
import { Domino, Player, GameState, DominoSide } from '../../src/core/types';
        ...
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.scroll}>
                ...
                <View style={styles.row}>
                    <DominoComponent domino={{ id: 'd1', left: 1, right: 4, isDouble: false, sum: 5 }} />
                    <View style={{ width: 10 }} />
                    <DominoComponent domino={{ id: 'd2', left: 6, right: 6, isDouble: true, sum: 12 }} />
                    <View style={{ width: 10 }} />
                    <DominoComponent domino={{ id: 'd3', left: 0, right: 2, isDouble: false, sum: 2 }} orientation="horizontal" />
                </View>
